...
class Tic_Tac_Toe():
    ...
    def play_again(self):
        ...
        self.board_status = np.zeros(shape=(3, 3))
        self.reset_board = False
        self.X_wins = self.O_wins = self.tie = False
    ...
    def display_gameover(self):
        ...
        self.canvas.create_text(size_of_board / 2, size_of_board - 50, font="cmr 30 bold",
                                fill="gray", text="Click anywhere to play again!")
